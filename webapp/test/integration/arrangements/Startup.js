sap.ui.define([
	"sap/ui/test/Opa5",
	"opensap/manageproducts/ManageProduct_w3/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("opensap.manageproducts.ManageProduct_w3.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "opensap.manageproducts.ManageProduct_w3",
					async: true
				},
				hash: oOptions.hash,
