sap.ui.define([
	...
	return Opa5.extend("opensap.manageproducts.ManageProduct_w3.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["opensap/manageproducts/ManageProduct_w3/localService/mockserver"], function (mockserver) {
